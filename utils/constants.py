...
DEFAULT_CONFIG_TEMPLATE = {
    ...
    'HOLE': {
        ...
        'WidthDiff': {
            ...
            'group': 'geometry', 
            'label': 'Sai lệch rộng', 
            'col': 'Calculated_WidthDiff', 
            'use_abs': True, 
            'bins': [0, 5, 10, 15, 20, 25, float('inf')], 
            'labels': ['C1', 'C2', 'C3', 'C4', 'C5', 'C6'], 
            'scores_value': [1, 2, 3, 4, 5, 6], 
            'heatmap_cols': SINGLE_VAL_HEATMAP
        },

        # === CƠ LÝ (Properties) - Đổi C0-C5 thành C1-C6 ===
    'YieldPoint': {
        'mode': 'value', 'group': 'mechanical', 'label': 'GH Chảy', 'col': 'GIỚI HẠN CHẢY',
        'bins': [0, 245, 260, 300, 320, 360, 380, float('inf')], 
    ...
    'Tensile': {
        'mode': 'value', 'group': 'mechanical', 'label': 'GH Bền', 'col': 'GIỚI HẠN BỀN',
        'bins': [0, 400, 420, 460, 480, 500, 510, float('inf')],
        'labels': ['C6', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6'],
        'scores_value': [6, 1, 2, 3, 4, 5, 6],
        'heatmap_cols': SINGLE_VAL_HEATMAP
    },
    ...
    'Elongation': {
        'mode': 'value', 'group': 'mechanical', 'label': 'Độ giãn', 'col': 'ĐỘ GIÃN DÀI',
        'bins': [0, 17, 22, 25, 30, 35, float('inf')],
        'labels': ['C6', 'C5', 'C4', 'C3', 'C2', 'C1'],
        'scores_value': [6, 5, 4, 3, 2, 1],
        'heatmap_cols': SINGLE_VAL_HEATMAP
    },

    'Hardness': {
        'mode': 'value', 'group': 'mechanical', 'label': 'Độ cứng', 'col': 'ĐỘ CỨNG',
        'bins': [0, 65, 70, 75, 80, 85, 90, float('inf')],
        'labels': ['C6', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6'],
        'scores_value': [6, 1, 2, 3, 4, 5, 6],
        'heatmap_cols': SINGLE_VAL_HEATMAP
    },
